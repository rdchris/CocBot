...
For $i=0 To 999999999 Step 1
	ConsoleWrite("In infintate loop")
	Sleep(1000)
EndFunc
...
;WinActivate("PicPick")
;baseEvaluationForAttack()
;MouseMove($battleMenuPositionsFindNext[0],$battleMenuPositionsFindNext[1])


;MsgBox(1,"Text",pixelSearchDoesThisExist($pixelSearchTroopDeplaymentZone,$pixelSearchKing)
;Local $giantBattleIconCoords = PixelSearch(70, 900, 1900, 1100, "0xF88F72")
;ConsoleWrite("Here it is!: " + $giantBattleIconCoords[0] & " " & $giantBattleIconCoords[1])
;MsgBox(1,"test",$giantBattleIconCoords[0] & " " & $giantBattleIconCoords[1])
;#ce