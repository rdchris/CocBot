...
Func reviewResourceFinding()
	if 	$goldAmount> 450000 and $elixirAmount < 200000 Then
		$goldAmount=50000
	EndIf

	if 	$elixirAmount> 450000 and $goldAmount < 200000 Then
		$elixirAmount=50000
	EndIf

	if $elixirAmount > 200000 and $goldAmount < 120000 Then
		$elixirAmount=20000
	EndIf

	if $goldAmount > 200000 and $elixirAmount < 120000 Then
		$goldAmount=20000
	EndIf
